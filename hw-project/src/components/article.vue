            ...
            artList: [
                {
                  id: 1,
                  tag: "Kitchen",
                  img: require('@/assets/img/img-art-01.png'),
          ...
          
                {
                  id: 2,
                  tag: "Bedroom",
                  img: require("@/assets/img/img-art-02.png"),
                  title: "Living Design",
                  text: "Lorem ipsum dolor sit amet, adipiscing Aliquam eu sem vitae turpmaximus.posuere in.Contrary to popular belief.There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injecthumour, or randomised words which dont look even slightly believable.",
                ...
                },
                {
                  id: 3,
                  tag: "Building",
                  img: require("@/assets/img/img-art-03.png"),
                ...
                },
                {
                  id: 4,
                  tag: "Architecture",
                  img: require("@/assets/img/img-art-04.png"),
                  title: "Kitchan Design",
                  text: "Lorem ipsum dolor sit amet, adipiscing Aliquam eu sem vitae turpmaximus.posuere in.Contrary to popular belief.There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injecthumour, or randomised words which dont look even slightly believable.",
                  date: "26 December,2022",
                },
                {
                  ...
                  img: require("@/assets/img/img-art-05.png"),
                  title: "Living Design",
                  text: "Lorem ipsum dolor sit amet, adipiscing Aliquam eu sem vitae turpmaximus.posuere in.Contrary to popular belief.There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injecthumour, or randomised words which dont look even slightly believable.",
                  date: "22 December,2022",
                },
                {
                  id: 6,
                  tag:"Bedroomer",
                  img: require("@/assets/img/img-art-06.png"),
                  title: "Interior Design",
                  text: "Lorem ipsum dolor sit amet, adipiscing Aliquam eu sem vitae turpmaximus.posuere in.Contrary to popular belief.There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injecthumour, or randomised words which dont look even slightly believable.",
                  date: "25 December,2022",
                },
